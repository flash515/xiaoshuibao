...
__DEFINE__(1664542419551, function(require, module, exports) {
...
}, function(modId) {var map = {"./keyvalue":1664542419552,"./signer":1664542419554,"./utils.http":1664542419556,"./utils.lang":1664542419553,"./utils":1664542419555}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664542419552, function(require, module, exports) {
...
}, function(modId) { var map = {"./utils.lang":1664542419553}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664542419553, function(require, module, exports) {
...
__DEFINE__(1664542419554, function(require, module, exports) {
...
class Signer {
    ...
    tc3sign(method, url, headers, params, timestamp, options = {}) {
        ...
        const formatedParams = isCloudApi ?
        ...
        const signedUrl = isCloudApi ? urlInfo.pathname : url.replace(/^https?:/, '').split('?')[0];
...
}, function(modId) { var map = {"./utils":1664542419555,"./utils.lang":1664542419553,"./keyvalue":1664542419552}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664542419555, function(require, module, exports) {
...
__DEFINE__(1664542419556, function(require, module, exports) {
...
}, function(modId) { var map = {"./utils":1664542419555,"./utils.lang":1664542419553}; return __REQUIRE__(map[modId], modId); })
return __REQUIRE__(1664542419551);
})()
